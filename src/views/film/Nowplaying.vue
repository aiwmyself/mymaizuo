...
export default {
  ...
  methods: {
    ...
    onLoad () {
      ...
      this.current++
      http({
        url: `/gateway?cityId=${this.cityId}&pageNum=${this.current}&pageSize=10&type=1&k=9967013`,
        headers: {
          'X-Client-Info':
    ...
    ...mapMutations('TabbarModule', ['show'])
  },
  computed: {
  ...
  mounted () {
    ...
    http({
      url:
        `/gateway?cityId=${this.cityId}&pageNum=1&pageSize=10&type=1&k=9967013`,
      headers: {
        'X-Client-Info':
          '{"a":"3000","ch":"1002","v":"5.0.4","e":"16225381261882046079172609","bc":"110100"}',
        'X-Host': 'mall.film-ticket.film.list'
